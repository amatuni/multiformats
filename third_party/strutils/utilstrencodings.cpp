...
bool ParseInt32(const std::string& str, int32_t* out) {
  ...
  // over/underflow we still have to check that the returned value is within the
  // range of an *int32_t*. On 64-bit platforms the size of these types may be
  // different.
...
bool ParseInt64(const std::string& str, int64_t* out) {
  ...
  // report an over/underflow we still have to check that the returned value is
